...
pub const N_SYSVEC:   usize = 16;
pub const N_INTVEC:   usize = 26;

// number of CPU core
pub const CPU_CORE_NUM:     usize = 2;

// CPU core spinlock
pub const SPINLOCK_SYNC_C0: u32 = 0;
pub const SPINLOCK_SYNC_C1: u32 = 1;
pub const SPINLOCK_DEBUG  : u32 = 2;
pub const SPINLOCK_KERNEL : u32 = 3;

// #[no_mangle]
// Spinlock register array for SPINLOCK_KERNEL(3)
// pub static SPINLOCK_KERNEL_V : u32 = 0xD000_010C;

// CPU core interrupt
pub const ICCINT_DISPATCH : usize = 1;
pub const ICCINT_ENAINT   : usize = 2;
pub const ICCINT_DISINT   : usize = 3;
...
pub const SIO_CPUID:    u32 = SIO_BASE + 0x00 as u32;
...
// #[no_mangle]
// pub static SIO_CPUID_V: u32 = SIO_CPUID;

pub const FIFO_ST:      u32 = SIO_BASE + 0x50 as u32;
pub const FIFO_WR:      u32 = SIO_BASE + 0x54 as u32;
pub const FIFO_RD:      u32 = SIO_BASE + 0x58 as u32;

pub const FIFO_ST_VLD:  u32 = 1 ;
pub const FIFO_ST_RDY:  u32 = 2 ;
...
// Spinlock Register Array
pub fn spinlock(n: u32) -> u32 {
    let addr = SIO_BASE + 0x100 as u32 + (n * 4) as u32;
    addr
}
...
pub fn nvic_iser(n: u32) -> usize {
    let addr = (NVIC_ISER + (n / 32) * 4) as usize ;
    addr
}

pub const NVIC_ICER:   u32 = 0xE000_E180;
pub fn nvic_icer(n: u32) -> usize {
    let addr = (NVIC_ICER + (n / 32) * 4) as usize ;
    addr
}

pub const NVIC_ISPR:   u32 = 0xE000_E200;
pub fn nvic_ispr(n: u32) -> usize {
    let addr = (NVIC_ISPR + (n / 32) * 4) as usize ;
    addr
}

pub const NVIC_ICPR:   u32 = 0xE000_E280;
pub fn nvic_icpr(n: u32) -> usize {
    let addr = (NVIC_ICPR + (n / 32) * 4) as usize ;
    addr
}

pub const NVIC_IPR:    u32 = 0xE000_E400;
pub fn nvic_ipr(n: u32) -> usize {
    let addr =  (NVIC_IPR + n) as usize ;
    addr
}
